...
flexbe_msgs__msg__UserdataInfo__init(flexbe_msgs__msg__UserdataInfo * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->state)) {
    flexbe_msgs__msg__UserdataInfo__fini(msg);
    return false;
  }
  // key
...
flexbe_msgs__msg__UserdataInfo__create()
{
  ...
  memset(msg, 0, sizeof(flexbe_msgs__msg__UserdataInfo));
  bool success = flexbe_msgs__msg__UserdataInfo__init(msg);
  if (!success) {
...
flexbe_msgs__msg__UserdataInfo__Sequence__init(flexbe_msgs__msg__UserdataInfo__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  flexbe_msgs__msg__UserdataInfo * data = NULL;

  if (size) {
    data = (flexbe_msgs__msg__UserdataInfo *)allocator.zero_allocate(size, sizeof(flexbe_msgs__msg__UserdataInfo), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = flexbe_msgs__msg__UserdataInfo__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        flexbe_msgs__msg__UserdataInfo__fini(&data[i - 1]);
      }
...
flexbe_msgs__msg__UserdataInfo__Sequence__fini(flexbe_msgs__msg__UserdataInfo__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      flexbe_msgs__msg__UserdataInfo__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  flexbe_msgs__msg__UserdataInfo__Sequence * array = (flexbe_msgs__msg__UserdataInfo__Sequence *)allocator.allocate(sizeof(flexbe_msgs__msg__UserdataInfo__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = flexbe_msgs__msg__UserdataInfo__Sequence__init(array, size);
  if (!success) {
...
flexbe_msgs__msg__UserdataInfo__Sequence__destroy(flexbe_msgs__msg__UserdataInfo__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    flexbe_msgs__msg__UserdataInfo__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
flexbe_msgs__msg__UserdataInfo__Sequence__are_equal(const flexbe_msgs__msg__UserdataInfo__Sequence * lhs, const flexbe_msgs__msg__UserdataInfo__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!flexbe_msgs__msg__UserdataInfo__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  flexbe_msgs__msg__UserdataInfo__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(flexbe_msgs__msg__UserdataInfo);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    flexbe_msgs__msg__UserdataInfo * data =
      (flexbe_msgs__msg__UserdataInfo *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!flexbe_msgs__msg__UserdataInfo__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          flexbe_msgs__msg__UserdataInfo__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!flexbe_msgs__msg__UserdataInfo__copy(
