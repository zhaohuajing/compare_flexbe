...
#ifndef COMPARE_FLEXBE_UTILITIES__SRV__DETAIL__GET_POINT_CLOUD__FUNCTIONS_H_
#define COMPARE_FLEXBE_UTILITIES__SRV__DETAIL__GET_POINT_CLOUD__FUNCTIONS_H_
 ...
 * )) before or use
 * compare_flexbe_utilities__srv__GetPointCloud_Request__create()
 ...
 * calls
 * compare_flexbe_utilities__srv__GetPointCloud_Request__init().
...
/**
 * It calls
 * compare_flexbe_utilities__srv__GetPointCloud_Request__fini()
...
/**
 * It calls
 * compare_flexbe_utilities__srv__GetPointCloud_Request__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * compare_flexbe_utilities__srv__GetPointCloud_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_compare_flexbe_utilities
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * compare_flexbe_utilities__srv__GetPointCloud_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_compare_flexbe_utilities
...
/**
 * It calls
 * compare_flexbe_utilities__srv__GetPointCloud_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_compare_flexbe_utilities
...
/**
 * It calls
 * compare_flexbe_utilities__srv__GetPointCloud_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COMPARE_FLEXBE_UTILITIES__SRV__DETAIL__GET_POINT_CLOUD__FUNCTIONS_H_
