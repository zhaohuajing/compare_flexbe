...
compare_flexbe_utilities__srv__CartesianMoveToPose_Request__init(compare_flexbe_utilities__srv__CartesianMoveToPose_Request * msg)
{
  ...
  if (!geometry_msgs__msg__Pose__Sequence__init(&msg->waypoints, 0)) {
    compare_flexbe_utilities__srv__CartesianMoveToPose_Request__fini(msg);
    return false;
  }
  return true;
}
...
compare_flexbe_utilities__srv__CartesianMoveToPose_Request__create()
{
  ...
  compare_flexbe_utilities__srv__CartesianMoveToPose_Request * msg = (compare_flexbe_utilities__srv__CartesianMoveToPose_Request *)allocator.allocate(sizeof(compare_flexbe_utilities__srv__CartesianMoveToPose_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(compare_flexbe_utilities__srv__CartesianMoveToPose_Request));
  bool success = compare_flexbe_utilities__srv__CartesianMoveToPose_Request__init(msg);
  if (!success) {
...
compare_flexbe_utilities__srv__CartesianMoveToPose_Request__Sequence__init(compare_flexbe_utilities__srv__CartesianMoveToPose_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  compare_flexbe_utilities__srv__CartesianMoveToPose_Request * data = NULL;

  if (size) {
    data = (compare_flexbe_utilities__srv__CartesianMoveToPose_Request *)allocator.zero_allocate(size, sizeof(compare_flexbe_utilities__srv__CartesianMoveToPose_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = compare_flexbe_utilities__srv__CartesianMoveToPose_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        compare_flexbe_utilities__srv__CartesianMoveToPose_Request__fini(&data[i - 1]);
      }
...
compare_flexbe_utilities__srv__CartesianMoveToPose_Request__Sequence__fini(compare_flexbe_utilities__srv__CartesianMoveToPose_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      compare_flexbe_utilities__srv__CartesianMoveToPose_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  compare_flexbe_utilities__srv__CartesianMoveToPose_Request__Sequence * array = (compare_flexbe_utilities__srv__CartesianMoveToPose_Request__Sequence *)allocator.allocate(sizeof(compare_flexbe_utilities__srv__CartesianMoveToPose_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = compare_flexbe_utilities__srv__CartesianMoveToPose_Request__Sequence__init(array, size);
  if (!success) {
...
compare_flexbe_utilities__srv__CartesianMoveToPose_Request__Sequence__destroy(compare_flexbe_utilities__srv__CartesianMoveToPose_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    compare_flexbe_utilities__srv__CartesianMoveToPose_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
compare_flexbe_utilities__srv__CartesianMoveToPose_Request__Sequence__are_equal(const compare_flexbe_utilities__srv__CartesianMoveToPose_Request__Sequence * lhs, const compare_flexbe_utilities__srv__CartesianMoveToPose_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!compare_flexbe_utilities__srv__CartesianMoveToPose_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  compare_flexbe_utilities__srv__CartesianMoveToPose_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(compare_flexbe_utilities__srv__CartesianMoveToPose_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    compare_flexbe_utilities__srv__CartesianMoveToPose_Request * data =
      (compare_flexbe_utilities__srv__CartesianMoveToPose_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!compare_flexbe_utilities__srv__CartesianMoveToPose_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          compare_flexbe_utilities__srv__CartesianMoveToPose_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!compare_flexbe_utilities__srv__CartesianMoveToPose_Request__copy(
...
compare_flexbe_utilities__srv__CartesianMoveToPose_Response__are_equal(const compare_flexbe_utilities__srv__CartesianMoveToPose_Response * lhs, const compare_flexbe_utilities__srv__CartesianMoveToPose_Response * rhs)
{
  ...
  // percentage_planned
  if (lhs->percentage_planned != rhs->percentage_planned) {
    return false;
  }
  return true;
}
  ...
  compare_flexbe_utilities__srv__CartesianMoveToPose_Response * output)
{
  ...
  // percentage_planned
  output->percentage_planned = input->percentage_planned;
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  compare_flexbe_utilities__srv__CartesianMoveToPose_Response * msg = (compare_flexbe_utilities__srv__CartesianMoveToPose_Response *)allocator.allocate(sizeof(compare_flexbe_utilities__srv__CartesianMoveToPose_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(compare_flexbe_utilities__srv__CartesianMoveToPose_Response));
  bool success = compare_flexbe_utilities__srv__CartesianMoveToPose_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
compare_flexbe_utilities__srv__CartesianMoveToPose_Response__destroy(compare_flexbe_utilities__srv__CartesianMoveToPose_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    compare_flexbe_utilities__srv__CartesianMoveToPose_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
compare_flexbe_utilities__srv__CartesianMoveToPose_Response__Sequence__init(compare_flexbe_utilities__srv__CartesianMoveToPose_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  compare_flexbe_utilities__srv__CartesianMoveToPose_Response * data = NULL;

  if (size) {
    data = (compare_flexbe_utilities__srv__CartesianMoveToPose_Response *)allocator.zero_allocate(size, sizeof(compare_flexbe_utilities__srv__CartesianMoveToPose_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = compare_flexbe_utilities__srv__CartesianMoveToPose_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        compare_flexbe_utilities__srv__CartesianMoveToPose_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
compare_flexbe_utilities__srv__CartesianMoveToPose_Response__Sequence__fini(compare_flexbe_utilities__srv__CartesianMoveToPose_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      compare_flexbe_utilities__srv__CartesianMoveToPose_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  compare_flexbe_utilities__srv__CartesianMoveToPose_Response__Sequence * array = (compare_flexbe_utilities__srv__CartesianMoveToPose_Response__Sequence *)allocator.allocate(sizeof(compare_flexbe_utilities__srv__CartesianMoveToPose_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = compare_flexbe_utilities__srv__CartesianMoveToPose_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
compare_flexbe_utilities__srv__CartesianMoveToPose_Response__Sequence__destroy(compare_flexbe_utilities__srv__CartesianMoveToPose_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    compare_flexbe_utilities__srv__CartesianMoveToPose_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
compare_flexbe_utilities__srv__CartesianMoveToPose_Response__Sequence__are_equal(const compare_flexbe_utilities__srv__CartesianMoveToPose_Response__Sequence * lhs, const compare_flexbe_utilities__srv__CartesianMoveToPose_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!compare_flexbe_utilities__srv__CartesianMoveToPose_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  compare_flexbe_utilities__srv__CartesianMoveToPose_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(compare_flexbe_utilities__srv__CartesianMoveToPose_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    compare_flexbe_utilities__srv__CartesianMoveToPose_Response * data =
      (compare_flexbe_utilities__srv__CartesianMoveToPose_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!compare_flexbe_utilities__srv__CartesianMoveToPose_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          compare_flexbe_utilities__srv__CartesianMoveToPose_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!compare_flexbe_utilities__srv__CartesianMoveToPose_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
