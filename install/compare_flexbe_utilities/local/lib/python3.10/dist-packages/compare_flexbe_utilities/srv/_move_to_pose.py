...
class Metaclass_MoveToPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'compare_flexbe_utilities.srv.MoveToPose')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from compare_flexbe_utilities.srv import _move_to_pose
...
class MoveToPose(metaclass=Metaclass_MoveToPose):
    from compare_flexbe_utilities.srv._move_to_pose import MoveToPose_Request as Request
    from compare_flexbe_utilities.srv._move_to_pose import MoveToPose_Response as Response
