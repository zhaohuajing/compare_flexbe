...
{
  new (message_memory) tm_msgs::msg::StaResponse(_init);
}

void StaResponse_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tm_msgs::msg::StaResponse *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StaResponse_message_member_array[3] = {
  {
    ...
    offsetof(tm_msgs::msg::StaResponse, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tm_msgs::msg::StaResponse, subcmd),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tm_msgs::msg::StaResponse, subdata),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StaResponse_message_members = {
  ...
  3,  // number of fields
  sizeof(tm_msgs::msg::StaResponse),
...
{
  return &::tm_msgs::msg::rosidl_typesupport_introspection_cpp::StaResponse_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tm_msgs, msg, StaResponse)() {
  return &::tm_msgs::msg::rosidl_typesupport_introspection_cpp::StaResponse_message_type_support_handle;
}
