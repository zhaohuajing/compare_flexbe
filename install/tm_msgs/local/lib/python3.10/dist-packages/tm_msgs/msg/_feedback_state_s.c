...
bool tm_msgs__msg__feedback_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // tmsrv_cperr
    PyObject * field = PyObject_GetAttrString(_pymsg, "tmsrv_cperr");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->tmsrv_cperr = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // tmscript_cperr
    PyObject * field = PyObject_GetAttrString(_pymsg, "tmscript_cperr");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->tmscript_cperr = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // tmsrv_dataerr
    PyObject * field = PyObject_GetAttrString(_pymsg, "tmsrv_dataerr");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->tmsrv_dataerr = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // tmscript_dataerr
    PyObject * field = PyObject_GetAttrString(_pymsg, "tmscript_dataerr");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->tmscript_dataerr = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // max_not_connect_in_s
    PyObject * field = PyObject_GetAttrString(_pymsg, "max_not_connect_in_s");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->max_not_connect_in_s = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // disconnection_times
    PyObject * field = PyObject_GetAttrString(_pymsg, "disconnection_times");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->disconnection_times = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // joint_pos
  ...
  {  // joint_tor_average
    PyObject * field = PyObject_GetAttrString(_pymsg, "joint_tor_average");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->joint_tor_average.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'joint_tor_average'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // joint_tor_min
    PyObject * field = PyObject_GetAttrString(_pymsg, "joint_tor_min");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->joint_tor_min.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'joint_tor_min'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // joint_tor_max
    PyObject * field = PyObject_GetAttrString(_pymsg, "joint_tor_max");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->joint_tor_max.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'joint_tor_max'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // camera_light
    ...
    assert(PyLong_Check(field));
    ros_message->camera_light = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // error_code
...
PyObject * tm_msgs__msg__feedback_state__convert_to_py(void * raw_ros_message)
{
  ...
  {  // tmsrv_cperr
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->tmsrv_cperr);
    {
      int rc = PyObject_SetAttrString(_pymessage, "tmsrv_cperr", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // tmscript_cperr
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->tmscript_cperr);
    {
      int rc = PyObject_SetAttrString(_pymessage, "tmscript_cperr", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // tmsrv_dataerr
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->tmsrv_dataerr);
    {
      int rc = PyObject_SetAttrString(_pymessage, "tmsrv_dataerr", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // tmscript_dataerr
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->tmscript_dataerr);
    {
      int rc = PyObject_SetAttrString(_pymessage, "tmscript_dataerr", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // max_not_connect_in_s
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->max_not_connect_in_s);
    {
      int rc = PyObject_SetAttrString(_pymessage, "max_not_connect_in_s", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // disconnection_times
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->disconnection_times);
    {
      int rc = PyObject_SetAttrString(_pymessage, "disconnection_times", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // joint_tor_average
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "joint_tor_average");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->joint_tor_average.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->joint_tor_average.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->joint_tor_average.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // joint_tor_min
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "joint_tor_min");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->joint_tor_min.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->joint_tor_min.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->joint_tor_min.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // joint_tor_max
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "joint_tor_max");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->joint_tor_max.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->joint_tor_max.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->joint_tor_max.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // camera_light
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->camera_light);
    {
