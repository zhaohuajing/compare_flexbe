...
bool tm_msgs__msg__sta_response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tm_msgs.msg._sta_response.StaResponse", full_classname_dest, 37) == 0);
  }
  tm_msgs__msg__StaResponse * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of StaResponse */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tm_msgs.msg._sta_response");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StaResponse");
