...
#ifndef _WIN32
# define DEPRECATED__tm_msgs__srv__SetIO_Event __attribute__((deprecated))
#else
# define DEPRECATED__tm_msgs__srv__SetIO_Event __declspec(deprecated)
#endif
...
struct SetIO_Event_
{
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<tm_msgs::srv::SetIO_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<tm_msgs::srv::SetIO_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<tm_msgs::srv::SetIO_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<tm_msgs::srv::SetIO_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<tm_msgs::srv::SetIO_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<tm_msgs::srv::SetIO_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<tm_msgs::srv::SetIO_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<tm_msgs::srv::SetIO_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    tm_msgs::srv::SetIO_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const tm_msgs::srv::SetIO_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<tm_msgs::srv::SetIO_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<tm_msgs::srv::SetIO_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      tm_msgs::srv::SetIO_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<tm_msgs::srv::SetIO_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      tm_msgs::srv::SetIO_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<tm_msgs::srv::SetIO_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<tm_msgs::srv::SetIO_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<tm_msgs::srv::SetIO_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__tm_msgs__srv__SetIO_Event
    std::shared_ptr<tm_msgs::srv::SetIO_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__tm_msgs__srv__SetIO_Event
    std::shared_ptr<tm_msgs::srv::SetIO_Event_<ContainerAllocator> const>
...
// alias to use template instance with default allocator
using SetIO_Event =
  tm_msgs::srv::SetIO_Event_<std::allocator<void>>;
...
struct SetIO
{
  ...
  using Event = tm_msgs::srv::SetIO_Event;
};
