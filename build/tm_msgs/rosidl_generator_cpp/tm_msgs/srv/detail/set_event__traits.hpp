...
inline std::string to_yaml(const SetEvent_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use tm_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const tm_msgs::srv::SetEvent_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  tm_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use tm_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const tm_msgs::srv::SetEvent_Event & msg)
{
  return tm_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<tm_msgs::srv::SetEvent_Event>()
{
  return "tm_msgs::srv::SetEvent_Event";
}

template<>
inline const char * name<tm_msgs::srv::SetEvent_Event>()
{
  return "tm_msgs/srv/SetEvent_Event";
}

template<>
struct has_fixed_size<tm_msgs::srv::SetEvent_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<tm_msgs::srv::SetEvent_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<tm_msgs::srv::SetEvent_Request>::value && has_bounded_size<tm_msgs::srv::SetEvent_Response>::value> {};

template<>
struct is_message<tm_msgs::srv::SetEvent_Event>
  : std::true_type {};
