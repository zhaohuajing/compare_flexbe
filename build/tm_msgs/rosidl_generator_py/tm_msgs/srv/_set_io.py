...
class SetIO_Event(metaclass=Metaclass_SetIO_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<tm_msgs/SetIO_Request, 1>',
        'response': 'sequence<tm_msgs/SetIO_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['tm_msgs', 'srv'], 'SetIO_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['tm_msgs', 'srv'], 'SetIO_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from tm_msgs.srv import SetIO_Request
    ...
    def response(self, value):
        if self._check_fields:
            from tm_msgs.srv import SetIO_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class SetIO(metaclass=Metaclass_SetIO):
    ...
    from tm_msgs.srv._set_io import SetIO_Event as Event
