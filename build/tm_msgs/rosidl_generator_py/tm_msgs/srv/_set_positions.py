...
class Metaclass_SetPositions_Event(type):
    """Metaclass of message 'SetPositions_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_positions__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_positions__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_positions__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_positions__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_positions__event
...
class SetPositions_Event(metaclass=Metaclass_SetPositions_Event):
    """Message class 'SetPositions_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<tm_msgs/SetPositions_Request, 1>',
        'response': 'sequence<tm_msgs/SetPositions_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['tm_msgs', 'srv'], 'SetPositions_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['tm_msgs', 'srv'], 'SetPositions_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from tm_msgs.srv import SetPositions_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetPositions_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetPositions_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from tm_msgs.srv import SetPositions_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetPositions_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetPositions_Response'"
...
class Metaclass_SetPositions(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_positions.Metaclass_SetPositions_Event._TYPE_SUPPORT is None:
                _set_positions.Metaclass_SetPositions_Event.__import_type_support__()
...
class SetPositions(metaclass=Metaclass_SetPositions):
    ...
    from tm_msgs.srv._set_positions import SetPositions_Event as Event
