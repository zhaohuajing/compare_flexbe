...
class ConnectTM_Request(metaclass=Metaclass_ConnectTM_Request):
    ...
    def timeval(self, value):
        if self._check_fields:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'timeval' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._timeval = value
...
class Metaclass_ConnectTM_Event(type):
    """Metaclass of message 'ConnectTM_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__connect_tm__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__connect_tm__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__connect_tm__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__connect_tm__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__connect_tm__event
...
class ConnectTM_Event(metaclass=Metaclass_ConnectTM_Event):
    """Message class 'ConnectTM_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<tm_msgs/ConnectTM_Request, 1>',
        'response': 'sequence<tm_msgs/ConnectTM_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['tm_msgs', 'srv'], 'ConnectTM_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['tm_msgs', 'srv'], 'ConnectTM_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from tm_msgs.srv import ConnectTM_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, ConnectTM_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ConnectTM_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from tm_msgs.srv import ConnectTM_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ConnectTM_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ConnectTM_Response'"
...
class Metaclass_ConnectTM(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _connect_tm.Metaclass_ConnectTM_Event._TYPE_SUPPORT is None:
                _connect_tm.Metaclass_ConnectTM_Event.__import_type_support__()
...
class ConnectTM(metaclass=Metaclass_ConnectTM):
    ...
    from tm_msgs.srv._connect_tm import ConnectTM_Event as Event
