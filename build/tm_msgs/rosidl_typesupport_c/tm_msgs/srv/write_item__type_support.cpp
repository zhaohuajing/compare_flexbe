...
static const _WriteItem_Event_type_support_symbol_names_t _WriteItem_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tm_msgs, srv, WriteItem_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tm_msgs, srv, WriteItem_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tm_msgs, srv, WriteItem_Event)() {
  return &::tm_msgs::srv::rosidl_typesupport_c::WriteItem_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t WriteItem_service_type_support_handle = {
  ...
  &WriteItem_Request_message_type_support_handle,
  &WriteItem_Response_message_type_support_handle,
  &WriteItem_Event_message_type_support_handle,
