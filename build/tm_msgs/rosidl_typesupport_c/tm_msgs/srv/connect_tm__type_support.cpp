...
static const _ConnectTM_Request_type_support_symbol_names_t _ConnectTM_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tm_msgs, srv, ConnectTM_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tm_msgs, srv, ConnectTM_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tm_msgs, srv, ConnectTM_Request)() {
  return &::tm_msgs::srv::rosidl_typesupport_c::ConnectTM_Request_message_type_support_handle;
}
...
static const _ConnectTM_Response_type_support_symbol_names_t _ConnectTM_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tm_msgs, srv, ConnectTM_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tm_msgs, srv, ConnectTM_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tm_msgs, srv, ConnectTM_Response)() {
  return &::tm_msgs::srv::rosidl_typesupport_c::ConnectTM_Response_message_type_support_handle;
}
...
typedef struct _ConnectTM_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _ConnectTM_Event_type_support_ids_t;

static const _ConnectTM_Event_type_support_ids_t _ConnectTM_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_c",  // ::rosidl_typesupport_fastrtps_c::typesupport_identifier,
    "rosidl_typesupport_introspection_c",  // ::rosidl_typesupport_introspection_c::typesupport_identifier,
  }
...
typedef struct _ConnectTM_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _ConnectTM_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _ConnectTM_Event_type_support_symbol_names_t _ConnectTM_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tm_msgs, srv, ConnectTM_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tm_msgs, srv, ConnectTM_Event)),
  }
};

typedef struct _ConnectTM_Event_type_support_data_t
{
  void * data[2];
} _ConnectTM_Event_type_support_data_t;

static _ConnectTM_Event_type_support_data_t _ConnectTM_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _ConnectTM_Event_message_typesupport_map = {
  2,
  "tm_msgs",
  &_ConnectTM_Event_message_typesupport_ids.typesupport_identifier[0],
  &_ConnectTM_Event_message_typesupport_symbol_names.symbol_name[0],
  &_ConnectTM_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t ConnectTM_Event_message_type_support_handle = {
  rosidl_typesupport_c__typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_ConnectTM_Event_message_typesupport_map),
  rosidl_typesupport_c__get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tm_msgs, srv, ConnectTM_Event)() {
  return &::tm_msgs::srv::rosidl_typesupport_c::ConnectTM_Event_message_type_support_handle;
}
...
static const _ConnectTM_type_support_symbol_names_t _ConnectTM_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tm_msgs, srv, ConnectTM)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tm_msgs, srv, ConnectTM)),
  }
};
...
static const rosidl_service_type_support_t ConnectTM_service_type_support_handle = {
  ...
  &ConnectTM_Request_message_type_support_handle,
  &ConnectTM_Response_message_type_support_handle,
  &ConnectTM_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, tm_msgs, srv, ConnectTM)() {
  return &::tm_msgs::srv::rosidl_typesupport_c::ConnectTM_service_type_support_handle;
}
