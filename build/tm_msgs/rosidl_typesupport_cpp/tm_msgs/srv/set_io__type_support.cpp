...
static const _SetIO_Event_type_support_symbol_names_t _SetIO_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tm_msgs, srv, SetIO_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tm_msgs, srv, SetIO_Event)),
  }
};
...
{
  return &::tm_msgs::srv::rosidl_typesupport_cpp::SetIO_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tm_msgs, srv, SetIO_Event)() {
  return get_message_type_support_handle<tm_msgs::srv::SetIO_Event>();
}
...
static const rosidl_service_type_support_t SetIO_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<tm_msgs::srv::SetIO_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<tm_msgs::srv::SetIO_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<tm_msgs::srv::SetIO_Event>(),
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, tm_msgs, srv, SetIO)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<tm_msgs::srv::SetIO>();
}
