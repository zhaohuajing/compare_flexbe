...
#ifndef TM_MSGS__MSG__DETAIL__SVR_RESPONSE__FUNCTIONS_H_
#define TM_MSGS__MSG__DETAIL__SVR_RESPONSE__FUNCTIONS_H_
 ...
 * calls
 * tm_msgs__msg__SvrResponse__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tm_msgs
tm_msgs__msg__SvrResponse *
tm_msgs__msg__SvrResponse__create(void);

/// Destroy msg/SvrResponse message.
/**
 * It calls
 * tm_msgs__msg__SvrResponse__fini()
...
/// Check for msg/SvrResponse message equality.
/**
...
/// Copy a msg/SvrResponse message.
/**
 ...
 * tm_msgs__msg__SvrResponse__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * tm_msgs__msg__SvrResponse__Sequence__fini()
 * on the array,
...
/// Check for msg/SvrResponse message array equality.
/**
...
/// Copy an array of msg/SvrResponse messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
...
#endif  // TM_MSGS__MSG__DETAIL__SVR_RESPONSE__FUNCTIONS_H_
