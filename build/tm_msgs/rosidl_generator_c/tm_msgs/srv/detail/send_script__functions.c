...
tm_msgs__srv__SendScript_Request__create(void)
{
...
tm_msgs__srv__SendScript_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
bool
tm_msgs__srv__SendScript_Event__init(tm_msgs__srv__SendScript_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    tm_msgs__srv__SendScript_Event__fini(msg);
    return false;
  }
  // request
  if (!tm_msgs__srv__SendScript_Request__Sequence__init(&msg->request, 0)) {
    tm_msgs__srv__SendScript_Event__fini(msg);
    return false;
  }
  // response
  if (!tm_msgs__srv__SendScript_Response__Sequence__init(&msg->response, 0)) {
    tm_msgs__srv__SendScript_Event__fini(msg);
    return false;
  }
  return true;
...
void
tm_msgs__srv__SendScript_Event__fini(tm_msgs__srv__SendScript_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  tm_msgs__srv__SendScript_Request__Sequence__fini(&msg->request);
  // response
  tm_msgs__srv__SendScript_Response__Sequence__fini(&msg->response);
}

bool
tm_msgs__srv__SendScript_Event__are_equal(const tm_msgs__srv__SendScript_Event * lhs, const tm_msgs__srv__SendScript_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!tm_msgs__srv__SendScript_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!tm_msgs__srv__SendScript_Response__Sequence__are_equal(
...
bool
tm_msgs__srv__SendScript_Event__copy(
  const tm_msgs__srv__SendScript_Event * input,
  tm_msgs__srv__SendScript_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!tm_msgs__srv__SendScript_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!tm_msgs__srv__SendScript_Response__Sequence__copy(
...
tm_msgs__srv__SendScript_Event *
tm_msgs__srv__SendScript_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tm_msgs__srv__SendScript_Event * msg = (tm_msgs__srv__SendScript_Event *)allocator.allocate(sizeof(tm_msgs__srv__SendScript_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tm_msgs__srv__SendScript_Event));
  bool success = tm_msgs__srv__SendScript_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
tm_msgs__srv__SendScript_Event__destroy(tm_msgs__srv__SendScript_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    tm_msgs__srv__SendScript_Event__fini(msg);
...
bool
tm_msgs__srv__SendScript_Event__Sequence__init(tm_msgs__srv__SendScript_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tm_msgs__srv__SendScript_Event * data = NULL;

  if (size) {
    data = (tm_msgs__srv__SendScript_Event *)allocator.zero_allocate(size, sizeof(tm_msgs__srv__SendScript_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tm_msgs__srv__SendScript_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        tm_msgs__srv__SendScript_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
tm_msgs__srv__SendScript_Event__Sequence__fini(tm_msgs__srv__SendScript_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      tm_msgs__srv__SendScript_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
tm_msgs__srv__SendScript_Event__Sequence *
tm_msgs__srv__SendScript_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tm_msgs__srv__SendScript_Event__Sequence * array = (tm_msgs__srv__SendScript_Event__Sequence *)allocator.allocate(sizeof(tm_msgs__srv__SendScript_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tm_msgs__srv__SendScript_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
tm_msgs__srv__SendScript_Event__Sequence__destroy(tm_msgs__srv__SendScript_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tm_msgs__srv__SendScript_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
tm_msgs__srv__SendScript_Event__Sequence__are_equal(const tm_msgs__srv__SendScript_Event__Sequence * lhs, const tm_msgs__srv__SendScript_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tm_msgs__srv__SendScript_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
tm_msgs__srv__SendScript_Event__Sequence__copy(
  const tm_msgs__srv__SendScript_Event__Sequence * input,
  tm_msgs__srv__SendScript_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tm_msgs__srv__SendScript_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tm_msgs__srv__SendScript_Event * data =
      (tm_msgs__srv__SendScript_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tm_msgs__srv__SendScript_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tm_msgs__srv__SendScript_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!tm_msgs__srv__SendScript_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
