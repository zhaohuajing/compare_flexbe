...
enum
{
  tm_msgs__srv__SetIO_Event__request__MAX_SIZE = 1
};
// response
enum
{
  tm_msgs__srv__SetIO_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetIO in the package tm_msgs.
typedef struct tm_msgs__srv__SetIO_Event
{
  service_msgs__msg__ServiceEventInfo info;
  tm_msgs__srv__SetIO_Request__Sequence request;
  tm_msgs__srv__SetIO_Response__Sequence response;
} tm_msgs__srv__SetIO_Event;

// Struct for a sequence of tm_msgs__srv__SetIO_Event.
typedef struct tm_msgs__srv__SetIO_Event__Sequence
{
