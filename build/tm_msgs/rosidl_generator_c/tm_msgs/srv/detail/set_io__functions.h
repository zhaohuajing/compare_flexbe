...
// IWYU pragma: private, include "tm_msgs/srv/set_io.h"


#ifndef TM_MSGS__SRV__DETAIL__SET_IO__FUNCTIONS_H_
#define TM_MSGS__SRV__DETAIL__SET_IO__FUNCTIONS_H_
 ...
 * calls
 * tm_msgs__srv__SetIO_Request__init().
...
/**
 * It calls
 * tm_msgs__srv__SetIO_Request__fini()
 ...
 * tm_msgs__srv__SetIO_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * tm_msgs__srv__SetIO_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tm_msgs__srv__SetIO_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tm_msgs
...
/**
 * It calls
 * tm_msgs__srv__SetIO_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tm_msgs
...
/**
 * It allocates the memory for the array and calls
 * tm_msgs__srv__SetIO_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tm_msgs
...
/**
 * It calls
 * tm_msgs__srv__SetIO_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * tm_msgs__srv__SetIO_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_tm_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tm_msgs__srv__SetIO_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tm_msgs
...
/**
 * It calls
 * tm_msgs__srv__SetIO_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tm_msgs
...
/**
 * It allocates the memory for the array and calls
 * tm_msgs__srv__SetIO_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tm_msgs
...
/**
 * It calls
 * tm_msgs__srv__SetIO_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TM_MSGS__SRV__DETAIL__SET_IO__FUNCTIONS_H_
