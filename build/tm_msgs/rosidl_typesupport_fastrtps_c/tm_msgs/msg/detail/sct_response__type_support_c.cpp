  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tm_msgs__msg__SctResponse;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const tm_msgs__msg__SctResponse * ros_message = static_cast<const tm_msgs__msg__SctResponse *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_tm_msgs__msg__SctResponse(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  tm_msgs__msg__SctResponse * ros_message = static_cast<tm_msgs__msg__SctResponse *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_tm_msgs__msg__SctResponse(cdr, ros_message);
}
