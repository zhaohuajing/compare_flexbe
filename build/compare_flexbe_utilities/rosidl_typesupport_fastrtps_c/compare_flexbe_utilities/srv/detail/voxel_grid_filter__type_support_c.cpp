  ...
  void * untyped_ros_message)
{
  ...
  _VoxelGridFilter_Request__ros_msg_type * ros_message = static_cast<_VoxelGridFilter_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: input
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  void * untyped_ros_message)
{
  ...
  _VoxelGridFilter_Response__ros_msg_type * ros_message = static_cast<_VoxelGridFilter_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: filtered
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
