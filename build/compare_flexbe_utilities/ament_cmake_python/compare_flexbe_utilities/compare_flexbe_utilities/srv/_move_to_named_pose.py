...
class Metaclass_MoveToNamedPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'compare_flexbe_utilities.srv.MoveToNamedPose')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from compare_flexbe_utilities.srv import _move_to_named_pose
...
class MoveToNamedPose(metaclass=Metaclass_MoveToNamedPose):
    from compare_flexbe_utilities.srv._move_to_named_pose import MoveToNamedPose_Request as Request
    from compare_flexbe_utilities.srv._move_to_named_pose import MoveToNamedPose_Response as Response
