...
#ifndef COMPARE_FLEXBE_UTILITIES__SRV__DETAIL__PLANE_SEGMENTATION__FUNCTIONS_H_
#define COMPARE_FLEXBE_UTILITIES__SRV__DETAIL__PLANE_SEGMENTATION__FUNCTIONS_H_
...
/// Initialize srv/PlaneSegmentation message.
/**
 ...
 * )) before or use
 * compare_flexbe_utilities__srv__PlaneSegmentation_Request__create()
...
/// Finalize srv/PlaneSegmentation message.
/**
...
/// Create srv/PlaneSegmentation message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * compare_flexbe_utilities__srv__PlaneSegmentation_Request__init().
...
/// Destroy srv/PlaneSegmentation message.
/**
 * It calls
 * compare_flexbe_utilities__srv__PlaneSegmentation_Request__fini()
...
/// Check for srv/PlaneSegmentation message equality.
/**
...
/// Copy a srv/PlaneSegmentation message.
/**
...
/// Initialize array of srv/PlaneSegmentation messages.
/**
...
/// Finalize array of srv/PlaneSegmentation messages.
/**
 * It calls
 * compare_flexbe_utilities__srv__PlaneSegmentation_Request__fini()
...
/// Create array of srv/PlaneSegmentation messages.
/**
 * It allocates the memory for the array and calls
 * compare_flexbe_utilities__srv__PlaneSegmentation_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PlaneSegmentation messages.
/**
 * It calls
 * compare_flexbe_utilities__srv__PlaneSegmentation_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/PlaneSegmentation message array equality.
/**
...
/// Copy an array of srv/PlaneSegmentation messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * compare_flexbe_utilities__srv__PlaneSegmentation_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_compare_flexbe_utilities
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * compare_flexbe_utilities__srv__PlaneSegmentation_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_compare_flexbe_utilities
...
/**
 * It calls
 * compare_flexbe_utilities__srv__PlaneSegmentation_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_compare_flexbe_utilities
...
/**
 * It allocates the memory for the array and calls
 * compare_flexbe_utilities__srv__PlaneSegmentation_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_compare_flexbe_utilities
...
/**
 * It calls
 * compare_flexbe_utilities__srv__PlaneSegmentation_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COMPARE_FLEXBE_UTILITIES__SRV__DETAIL__PLANE_SEGMENTATION__FUNCTIONS_H_
