...
static const _EuclideanClustering_Event_type_support_symbol_names_t _EuclideanClustering_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, compare_flexbe_utilities, srv, EuclideanClustering_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, compare_flexbe_utilities, srv, EuclideanClustering_Event)),
  }
};
...
{
  return &::compare_flexbe_utilities::srv::rosidl_typesupport_cpp::EuclideanClustering_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, compare_flexbe_utilities, srv, EuclideanClustering_Event)() {
  return get_message_type_support_handle<compare_flexbe_utilities::srv::EuclideanClustering_Event>();
}
...
static const rosidl_service_type_support_t EuclideanClustering_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<compare_flexbe_utilities::srv::EuclideanClustering_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<compare_flexbe_utilities::srv::EuclideanClustering_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<compare_flexbe_utilities::srv::EuclideanClustering_Event>(),
