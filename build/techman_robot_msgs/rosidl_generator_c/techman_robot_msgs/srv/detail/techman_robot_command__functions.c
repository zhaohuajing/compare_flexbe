  ...
  techman_robot_msgs__srv__TechmanRobotCommand_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    techman_robot_msgs__srv__TechmanRobotCommand_Request * data =
      (techman_robot_msgs__srv__TechmanRobotCommand_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!techman_robot_msgs__srv__TechmanRobotCommand_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          techman_robot_msgs__srv__TechmanRobotCommand_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  techman_robot_msgs__srv__TechmanRobotCommand_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    techman_robot_msgs__srv__TechmanRobotCommand_Response * data =
      (techman_robot_msgs__srv__TechmanRobotCommand_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!techman_robot_msgs__srv__TechmanRobotCommand_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          techman_robot_msgs__srv__TechmanRobotCommand_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
techman_robot_msgs__srv__TechmanRobotCommand_Event__init(techman_robot_msgs__srv__TechmanRobotCommand_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    techman_robot_msgs__srv__TechmanRobotCommand_Event__fini(msg);
    return false;
  }
  // request
  if (!techman_robot_msgs__srv__TechmanRobotCommand_Request__Sequence__init(&msg->request, 0)) {
    techman_robot_msgs__srv__TechmanRobotCommand_Event__fini(msg);
    return false;
  }
  // response
  if (!techman_robot_msgs__srv__TechmanRobotCommand_Response__Sequence__init(&msg->response, 0)) {
    techman_robot_msgs__srv__TechmanRobotCommand_Event__fini(msg);
    return false;
  }
  return true;
...
techman_robot_msgs__srv__TechmanRobotCommand_Event__fini(techman_robot_msgs__srv__TechmanRobotCommand_Event * msg)
{
  ...
  // request
  techman_robot_msgs__srv__TechmanRobotCommand_Request__Sequence__fini(&msg->request);
  // response
  techman_robot_msgs__srv__TechmanRobotCommand_Response__Sequence__fini(&msg->response);
}
...
techman_robot_msgs__srv__TechmanRobotCommand_Event__are_equal(const techman_robot_msgs__srv__TechmanRobotCommand_Event * lhs, const techman_robot_msgs__srv__TechmanRobotCommand_Event * rhs)
{
  ...
  // request
  if (!techman_robot_msgs__srv__TechmanRobotCommand_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!techman_robot_msgs__srv__TechmanRobotCommand_Response__Sequence__are_equal(
  ...
  techman_robot_msgs__srv__TechmanRobotCommand_Event * output)
{
  ...
  // request
  if (!techman_robot_msgs__srv__TechmanRobotCommand_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!techman_robot_msgs__srv__TechmanRobotCommand_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  techman_robot_msgs__srv__TechmanRobotCommand_Event * msg = (techman_robot_msgs__srv__TechmanRobotCommand_Event *)allocator.allocate(sizeof(techman_robot_msgs__srv__TechmanRobotCommand_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(techman_robot_msgs__srv__TechmanRobotCommand_Event));
  bool success = techman_robot_msgs__srv__TechmanRobotCommand_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
techman_robot_msgs__srv__TechmanRobotCommand_Event__Sequence__init(techman_robot_msgs__srv__TechmanRobotCommand_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  techman_robot_msgs__srv__TechmanRobotCommand_Event * data = NULL;

  if (size) {
    data = (techman_robot_msgs__srv__TechmanRobotCommand_Event *)allocator.zero_allocate(size, sizeof(techman_robot_msgs__srv__TechmanRobotCommand_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = techman_robot_msgs__srv__TechmanRobotCommand_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        techman_robot_msgs__srv__TechmanRobotCommand_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
techman_robot_msgs__srv__TechmanRobotCommand_Event__Sequence__fini(techman_robot_msgs__srv__TechmanRobotCommand_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      techman_robot_msgs__srv__TechmanRobotCommand_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  techman_robot_msgs__srv__TechmanRobotCommand_Event__Sequence * array = (techman_robot_msgs__srv__TechmanRobotCommand_Event__Sequence *)allocator.allocate(sizeof(techman_robot_msgs__srv__TechmanRobotCommand_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = techman_robot_msgs__srv__TechmanRobotCommand_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
techman_robot_msgs__srv__TechmanRobotCommand_Event__Sequence__destroy(techman_robot_msgs__srv__TechmanRobotCommand_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    techman_robot_msgs__srv__TechmanRobotCommand_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
techman_robot_msgs__srv__TechmanRobotCommand_Event__Sequence__are_equal(const techman_robot_msgs__srv__TechmanRobotCommand_Event__Sequence * lhs, const techman_robot_msgs__srv__TechmanRobotCommand_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!techman_robot_msgs__srv__TechmanRobotCommand_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  techman_robot_msgs__srv__TechmanRobotCommand_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(techman_robot_msgs__srv__TechmanRobotCommand_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    techman_robot_msgs__srv__TechmanRobotCommand_Event * data =
      (techman_robot_msgs__srv__TechmanRobotCommand_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!techman_robot_msgs__srv__TechmanRobotCommand_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          techman_robot_msgs__srv__TechmanRobotCommand_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!techman_robot_msgs__srv__TechmanRobotCommand_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
