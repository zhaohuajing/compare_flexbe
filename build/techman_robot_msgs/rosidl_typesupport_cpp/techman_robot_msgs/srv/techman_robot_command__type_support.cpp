...
static const _TechmanRobotCommand_Event_type_support_symbol_names_t _TechmanRobotCommand_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, techman_robot_msgs, srv, TechmanRobotCommand_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, techman_robot_msgs, srv, TechmanRobotCommand_Event)),
  }
};
...
{
  return &::techman_robot_msgs::srv::rosidl_typesupport_cpp::TechmanRobotCommand_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, techman_robot_msgs, srv, TechmanRobotCommand_Event)() {
  return get_message_type_support_handle<techman_robot_msgs::srv::TechmanRobotCommand_Event>();
}
...
static const rosidl_service_type_support_t TechmanRobotCommand_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<techman_robot_msgs::srv::TechmanRobotCommand_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<techman_robot_msgs::srv::TechmanRobotCommand_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<techman_robot_msgs::srv::TechmanRobotCommand_Event>(),
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, techman_robot_msgs, srv, TechmanRobotCommand)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<techman_robot_msgs::srv::TechmanRobotCommand>();
}
