...
static const _TechmanRobotCommand_Request_type_support_symbol_names_t _TechmanRobotCommand_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, techman_robot_msgs, srv, TechmanRobotCommand_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, techman_robot_msgs, srv, TechmanRobotCommand_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, techman_robot_msgs, srv, TechmanRobotCommand_Request)() {
  return &::techman_robot_msgs::srv::rosidl_typesupport_c::TechmanRobotCommand_Request_message_type_support_handle;
}
...
static const _TechmanRobotCommand_Response_type_support_symbol_names_t _TechmanRobotCommand_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, techman_robot_msgs, srv, TechmanRobotCommand_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, techman_robot_msgs, srv, TechmanRobotCommand_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, techman_robot_msgs, srv, TechmanRobotCommand_Response)() {
  return &::techman_robot_msgs::srv::rosidl_typesupport_c::TechmanRobotCommand_Response_message_type_support_handle;
}
...
static const _TechmanRobotCommand_type_support_symbol_names_t _TechmanRobotCommand_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, techman_robot_msgs, srv, TechmanRobotCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, techman_robot_msgs, srv, TechmanRobotCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, techman_robot_msgs, srv, TechmanRobotCommand)() {
  return &::techman_robot_msgs::srv::rosidl_typesupport_c::TechmanRobotCommand_service_type_support_handle;
}
