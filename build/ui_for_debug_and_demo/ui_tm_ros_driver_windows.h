...
"        }"));
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "QuickView_GUI", nullptr));
#if QT_CONFIG(accessibility)
...
#endif // QT_CONFIG(accessibility)
        log_tabWidget->setTabText(log_tabWidget->indexOf(Console_output_tab), QCoreApplication::translate("MainWindow", "Console output", nullptr));
#if QT_CONFIG(accessibility)
...
#endif // QT_CONFIG(accessibility)
        clear_response_button->setText(QCoreApplication::translate("MainWindow", "Clear", nullptr));
        log_tabWidget->setTabText(log_tabWidget->indexOf(Robot_Response_tab), QCoreApplication::translate("MainWindow", "Robot_Response", nullptr));
        Connection_Status_groupBox->setTitle(QCoreApplication::translate("MainWindow", "Connection Status", nullptr));
        SvrClient_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; color:#ad7fa8;\">Ethernet</span></p></body></html>", nullptr));
        set_svr_re_connect_button->setText(QCoreApplication::translate("MainWindow", "Test", nullptr));
        svrclient_status_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#2e3436;\">NaN</span></p></body></html>", nullptr));
        ReConnect_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; color:#ffffff;\">Re-Connect</span></p></body></html>", nullptr));
        SctClient_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; color:#ad7fa8;\">Listen Node</span></p></body></html>", nullptr));
        sctclient_status_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#2e3436;\">NaN</span></p></body></html>", nullptr));
        set_sct_re_connect_button->setText(QCoreApplication::translate("MainWindow", "Test", nullptr));
        Connect_to_TM_Server_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; color:#ffffff;\">Connection</span></p></body></html>", nullptr));
        Robot_Status_groupBox->setTitle(QString());
        Project_Run_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; color:#eeeeec;\">Project_Run</span></p></body></html>", nullptr));
        project_run_status_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#2e3436;\">NaN</span></p></body></html>", nullptr));
        Project_Pause_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; color:#eeeeec;\">Project_Pause</span></p></body></html>", nullptr));
        project_pause_status_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#2e3436;\">NaN</span></p></body></html>", nullptr));
        Robot_Link_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; color:#eeeeec;\">Robot_Link</span></p></body></html>", nullptr));
        robot_link_status_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#2e3436;\">NaN</span></p></body></html>", nullptr));
        ESTOP_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; color:#eeeeec;\">ESTOP</span></p></body></html>", nullptr));
        estop_status_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#2e3436;\">NaN</span></p></body></html>", nullptr));
        Data_Table_Correct_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; color:#eeeeec;\">Data_Table_Correct</span></p></body></html>", nullptr));
        data_table_correct_status_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#2e3436;\">NaN</span></p></body></html>", nullptr));
        Safeguard_A_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; color:#eeeeec;\">Safeguard_A</span></p></body></html>", nullptr));
        safeguard_a_status_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#2e3436;\">NaN</span></p></body></html>", nullptr));
        Robot_Error_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; color:#eeeeec;\">Robot_Error</span></p></body></html>", nullptr));
        robot_error_status_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#2e3436;\">NaN</span></p></body></html>", nullptr));
        Error_Code_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; color:#eeeeec;\">Error_Code</span></p></body></html>", nullptr));
        error_code_status_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#2e3436;\">NaN</span></p></body></html>", nullptr));
        MA_Mode_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; color:#eeeeec;\">MA_Mode</span></p></body></html>", nullptr));
        ma_mode_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#2e3436;\">NaN</span></p></body></html>", nullptr));
        configure_tabWidget->setTabText(configure_tabWidget->indexOf(Robot_Status_tab), QCoreApplication::translate("MainWindow", "TM_Robot_Status", nullptr));
        ControlBox_groupBox->setTitle(QString());
        change_control_box_io_button->setText(QCoreApplication::translate("MainWindow", "H / L", nullptr));
        DO0_Ctrl_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; color:#ffffff;\">DO0 Ctrl</span></p></body></html>", nullptr));
        ctrl_do0_status_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#2e3436;\">NaN</span></p></body></html>", nullptr));
        configure_tabWidget->setTabText(configure_tabWidget->indexOf(ControlBox_tab), QCoreApplication::translate("MainWindow", "Control_Box", nullptr));
        CQ_Monitor_groupBox->setTitle(QString());
        LinkLost_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; color:#ffffff;\">LinkLost</span></p></body></html>", nullptr));
        linklost_status_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#2e3436;\">NaN</span></p></body></html>", nullptr));
        MaxLostTime_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; color:#ffffff;\">MaxLostTime (s)</span></p></body></html>", nullptr));
        maxlosttime_status_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#2e3436;\">NaN</span></p></body></html>", nullptr));
        configure_tabWidget->setTabText(configure_tabWidget->indexOf(CQ_Monitor_tab), QCoreApplication::translate("MainWindow", "CQ Monitor", nullptr));
        Close->setText(QCoreApplication::translate("MainWindow", "Quit_GUI", nullptr));
        Response_ROS_Node_groupBox->setTitle(QCoreApplication::translate("MainWindow", "Response ROS Node Status", nullptr));
        TMSVR_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; color:#ad7fa8;\">TMSVR</span></p></body></html>", nullptr));
        tmsrv_cperr_status_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#2e3436;\">NaN</span></p></body></html>", nullptr));
        DataErr_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; color:#ffffff;\">DataErr</span></p></body></html>", nullptr));
        TMScript_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; color:#ad7fa8;\">TMSCT / TMSTA </span></p></body></html>", nullptr));
        tmscript_cperr_status_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#2e3436;\">NaN</span></p></body></html>", nullptr));
        CPERR_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; color:#ffffff;\">CPERR</span></p></body></html>", nullptr));
        tmsrv_dataerr_status_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#2e3436;\">NaN</span></p></body></html>", nullptr));
        tmscript_dataerr_status_label->setText(QCoreApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#2e3436;\">NaN</span></p></body></html>", nullptr));
    } // retranslateUi
