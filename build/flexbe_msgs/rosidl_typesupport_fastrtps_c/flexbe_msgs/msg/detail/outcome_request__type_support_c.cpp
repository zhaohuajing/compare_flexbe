...
bool cdr_serialize_flexbe_msgs__msg__OutcomeRequest(
  const flexbe_msgs__msg__OutcomeRequest * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_flexbe_msgs
bool cdr_deserialize_flexbe_msgs__msg__OutcomeRequest(
  eprosima::fastcdr::Cdr & cdr,
  flexbe_msgs__msg__OutcomeRequest * ros_message)
{
  // Field name: outcome
  {
    cdr >> ros_message->outcome;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_flexbe_msgs
bool cdr_serialize_key_flexbe_msgs__msg__OutcomeRequest(
  const flexbe_msgs__msg__OutcomeRequest * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: outcome
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_flexbe_msgs
size_t get_serialized_size_key_flexbe_msgs__msg__OutcomeRequest(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _OutcomeRequest__ros_msg_type * ros_message = static_cast<const _OutcomeRequest__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_flexbe_msgs
size_t max_serialized_size_key_flexbe_msgs__msg__OutcomeRequest(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const flexbe_msgs__msg__OutcomeRequest * ros_message = static_cast<const flexbe_msgs__msg__OutcomeRequest *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_flexbe_msgs__msg__OutcomeRequest(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  flexbe_msgs__msg__OutcomeRequest * ros_message = static_cast<flexbe_msgs__msg__OutcomeRequest *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_flexbe_msgs__msg__OutcomeRequest(cdr, ros_message);
}
