  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const flexbe_msgs__msg__BehaviorModification * ros_message = static_cast<const flexbe_msgs__msg__BehaviorModification *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_flexbe_msgs__msg__BehaviorModification(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  flexbe_msgs__msg__BehaviorModification * ros_message = static_cast<flexbe_msgs__msg__BehaviorModification *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_flexbe_msgs__msg__BehaviorModification(cdr, ros_message);
}
