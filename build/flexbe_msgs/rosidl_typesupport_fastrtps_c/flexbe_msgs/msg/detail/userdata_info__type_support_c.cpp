...
#include "flexbe_msgs/msg/detail/userdata_info__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // data, key, state, type
#include "rosidl_runtime_c/string_functions.h"  // data, key, state, type

// forward declare type support functions


using _UserdataInfo__ros_msg_type = flexbe_msgs__msg__UserdataInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _UserdataInfo__ros_msg_type * ros_message = static_cast<const _UserdataInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: state
  {
  ...
  void * untyped_ros_message)
{
  ...
  _UserdataInfo__ros_msg_type * ros_message = static_cast<_UserdataInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: state
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _UserdataInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_flexbe_msgs__msg__UserdataInfo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = flexbe_msgs__msg__UserdataInfo;
    is_plain =
      (
...
static size_t _UserdataInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_flexbe_msgs__msg__UserdataInfo(
...
static message_type_support_callbacks_t __callbacks_UserdataInfo = {
  "flexbe_msgs::msg",
  "UserdataInfo",
...
static rosidl_message_type_support_t _UserdataInfo__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_UserdataInfo,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flexbe_msgs, msg, UserdataInfo)() {
  return &_UserdataInfo__type_support;
}
