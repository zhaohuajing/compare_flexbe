...
#include "flexbe_msgs/msg/detail/behavior_request__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const flexbe_msgs::msg::BehaviorRequest & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  flexbe_msgs::msg::BehaviorRequest & ros_message)
{
  // Member: behavior_name
  cdr >> ros_message.behavior_name;
  ...
  // Member: structure
  {
    ...
    ros_message.structure.resize(size);
    for (size_t i = 0; i < size; i++) {
      flexbe_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.structure[i]);
    }
  }
  ...
  // Member: structure
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.structure[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_flexbe_msgs
max_serialized_size_BehaviorRequest(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = flexbe_msgs::msg::BehaviorRequest;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_flexbe_msgs
max_serialized_size_key_BehaviorRequest(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const flexbe_msgs::msg::BehaviorRequest *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<flexbe_msgs::msg::BehaviorRequest *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BehaviorRequest__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const flexbe_msgs::msg::BehaviorRequest *>(
...
static size_t _BehaviorRequest__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BehaviorRequest(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BehaviorRequest__callbacks = {
  "flexbe_msgs::msg",
  "BehaviorRequest",
...
static rosidl_message_type_support_t _BehaviorRequest__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BehaviorRequest__callbacks,
...
{
  return &flexbe_msgs::msg::typesupport_fastrtps_cpp::_BehaviorRequest__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, flexbe_msgs, msg, BehaviorRequest)() {
  return &flexbe_msgs::msg::typesupport_fastrtps_cpp::_BehaviorRequest__handle;
}
