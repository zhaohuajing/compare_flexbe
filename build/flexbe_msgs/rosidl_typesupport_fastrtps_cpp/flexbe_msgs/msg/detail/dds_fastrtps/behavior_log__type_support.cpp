...
#include "flexbe_msgs/msg/detail/behavior_log__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const flexbe_msgs::msg::BehaviorLog & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  flexbe_msgs::msg::BehaviorLog & ros_message)
{
  // Member: text
  cdr >> ros_message.text;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_flexbe_msgs
max_serialized_size_BehaviorLog(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = flexbe_msgs::msg::BehaviorLog;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_flexbe_msgs
max_serialized_size_key_BehaviorLog(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const flexbe_msgs::msg::BehaviorLog *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<flexbe_msgs::msg::BehaviorLog *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BehaviorLog__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const flexbe_msgs::msg::BehaviorLog *>(
...
static size_t _BehaviorLog__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BehaviorLog(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BehaviorLog__callbacks = {
  "flexbe_msgs::msg",
  "BehaviorLog",
...
static rosidl_message_type_support_t _BehaviorLog__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BehaviorLog__callbacks,
...
{
  return &flexbe_msgs::msg::typesupport_fastrtps_cpp::_BehaviorLog__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, flexbe_msgs, msg, BehaviorLog)() {
  return &flexbe_msgs::msg::typesupport_fastrtps_cpp::_BehaviorLog__handle;
}
