...
#include "flexbe_msgs/msg/detail/container_structure__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const flexbe_msgs::msg::Container &,
...
cdr_serialize(
  const flexbe_msgs::msg::ContainerStructure & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  flexbe_msgs::msg::ContainerStructure & ros_message)
{
  // Member: behavior_id
  cdr >> ros_message.behavior_id;
  ...
  // Member: containers
  {
    ...
    ros_message.containers.resize(size);
    for (size_t i = 0; i < size; i++) {
      flexbe_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.containers[i]);
    }
  }
  ...
  // Member: containers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.containers[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_flexbe_msgs
max_serialized_size_ContainerStructure(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: containers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        flexbe_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Container(
  ...
  if (is_plain) {
    ...
    using DataType = flexbe_msgs::msg::ContainerStructure;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_flexbe_msgs
max_serialized_size_key_ContainerStructure(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: containers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        flexbe_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Container(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const flexbe_msgs::msg::ContainerStructure *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<flexbe_msgs::msg::ContainerStructure *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ContainerStructure__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const flexbe_msgs::msg::ContainerStructure *>(
...
static size_t _ContainerStructure__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ContainerStructure(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ContainerStructure__callbacks = {
  "flexbe_msgs::msg",
  "ContainerStructure",
...
static rosidl_message_type_support_t _ContainerStructure__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ContainerStructure__callbacks,
...
{
  return &flexbe_msgs::msg::typesupport_fastrtps_cpp::_ContainerStructure__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, flexbe_msgs, msg, ContainerStructure)() {
  return &flexbe_msgs::msg::typesupport_fastrtps_cpp::_ContainerStructure__handle;
}
