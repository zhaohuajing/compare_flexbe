...
class Metaclass_ContainerStructure(type):
    """Metaclass of message 'ContainerStructure'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'flexbe_msgs.msg.ContainerStructure')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__container_structure
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__container_structure
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__container_structure
            cls._TYPE_SUPPORT = module.type_support_msg__msg__container_structure
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__container_structure
...
class ContainerStructure(metaclass=Metaclass_ContainerStructure):
    """Message class 'ContainerStructure'."""
    ...
    _fields_and_field_types = {
        'behavior_id': 'int32',
        'containers': 'sequence<flexbe_msgs/Container>',
    }
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'containers' field must be a set or sequence and each value of type 'Container'"
